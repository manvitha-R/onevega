...
//         try {
//           const response = await fetch('http://143.110.180.27:8003/client-users/',
//             {
//                 headers: {
...
//       try {
//         setIsDeleting(true);
//         const response = await fetch(http://143.110.180.27:8003/client-users/${userId}, {
//           method: 'DELETE',
//           headers: {
...
//             <Link href="/User" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex items-center">
//               <svg
...
//                         {/* Edit Icon - Using Link instead of window.location */}
